(function() {
  ...
  function bg() {
    ...
    setTimeout(function() {
      $(".background").css(
        "background",
        'url("assets/image/title-ori.jpg")  center center no-repeat'
      );
      ...
      setTimeout(function() {
        ...
        setTimeout(function () {
          ...
          window.loadStatus = "done";
          dp.play();
        }, 2500)
        

        $('#bgm-intro').animate({volume: 0.01}, 2500);
        $('#bgm-loop').animate({volume: 0.01}, 2500);
      }, 4500);
    }, 5000);
  }
